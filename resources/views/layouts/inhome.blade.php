...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <nav class="main-header navbar navbar-expand navbar-orange navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('home')}}" class="nav-link">Kembali Ke tampilan User</a>
                </li>
                    @guest
                            <li class="nav-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                   ...
                   with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{asset('/form-tambah-makanan')}}" class="nav-link active">
                   ...
                   <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{asset('/makanans')}}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Makanan</p>
                                    </a>
                                </li>
                   ...
                   <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{asset('/orderan')}}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pesanan</p>
                                    </a>
                                </li>
    ...
    <footer class="main-footer">
        <strong>Zhafirah&copy; XII RPL 1.</strong>
