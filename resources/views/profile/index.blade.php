...
<div class="container">
   ...
   <div class="card">
    <div class="card-body">
    <h4><i class="fa fa-pencil-alt"> Edit Profile</i></h4>
       ...
       <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea type="text" name="nohp" class="form-control @error('nohp') is-invalid @enderror" required="">{{ $user->nohp}}</textarea>
